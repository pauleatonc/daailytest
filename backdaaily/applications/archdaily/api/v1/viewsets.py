...
from .serializers import HomePageDataSerializer, CarouselItemSerializer, EditorChoiceSerializer
...
class CarouselViewSet(viewsets.ViewSet):
    def list(self, request):
        ...
        serializer = CarouselItemSerializer(data, many=True)
        return Response(serializer.data)

class EditorChoiceViewSet(viewsets.ViewSet):
    def list(self, request):
        data = {
            "title": "From Representation to Reality: 19 Projects that Rethink Representation Techniques",
            "src": "https://images.adsttc.com/media/images/622b/69cd/b9fa/780e/7d2e/f1ac/medium_jpg/fi.jpg",
        ...
        serializer = EditorChoiceSerializer(data)
        return Response(serializer.data)
